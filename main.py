...
async def main():
    ...
    while True:
        ...
        if all_tweets:
                ...
                if data.get("success"):
                    ...
                    if "media" in data:
                        for index, media in enumerate(data["media"]):
                            ...
                            print(f"Downloaded {media_url} as {image_path}")
            ...
            print(f"No tweets found for the user '{target_username}'.")
